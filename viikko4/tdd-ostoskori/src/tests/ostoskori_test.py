...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kaksi_samaa_tuotetta_ja_toinen_poistetaan_koriin_jaa_ostos_jossa_yksi_kpl(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_ainoan_tuotteen_poistamisen_jalkeen_kori_tyhja(self):
        self.kori.lisaa_tuote(self.leipa)
        self.kori.poista_tuote(self.leipa)
        ostokset = self.kori.ostokset()
        self.assertEqual(len(ostokset), 0)
    
    def test_tyhjennetaan_ostoskori(self):
        self.kori.lisaa_tuote(self.leipa)
        self.kori.lisaa_tuote(self.leipa)
        self.kori.lisaa_tuote(self.maito)
        self.kori.tyhjenna()
