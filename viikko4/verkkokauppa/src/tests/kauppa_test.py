...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(2, "moottorisaha", 20)
            if tuote_id == 3:
                return Tuote(3, "lasinpesuneste", 4)
    ...
    def test_ostetaan_kaksi_varastossa_olevaa_tuotetta(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with('pekka', ANY, '12345', ANY, 25)
    ...
    def test_ostetaan_kaksi_samaa_tuotetta(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with('pekka', ANY, '12345', ANY, 40)    

    def test_yritetaan_ostaa_loppunutta_tuotetta(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
